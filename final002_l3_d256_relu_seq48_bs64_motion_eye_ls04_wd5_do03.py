...
from models.clip import MotionEyeCLIP as Net
...
cfg.exp_name = 'final002_l3_d256_relu_seq48_bs64_motion_eye_ls04_wd5_do03'
...
cfg.train.feature_path = '../input/preprocessed_data//pre_select_features_eye.pkl'
...
cfg.train.motion_features = True
...
cfg.valid.feature_path = '../input/preprocessed_data//pre_select_features_eye.pkl'
cfg.valid.motion_features = True

cfg.model.max_len = MAX_LEN
cfg.model.num_features = 61
cfg.model.num_classes = 250
cfg.model.loss_type = 'ls_bce'
cfg.model.label_smoothing = 0.4
cfg.model.final_drop_rate = 0.3

cfg.model.clip.hidden_size = 256
cfg.model.clip.intermediate_size = 512
cfg.model.clip.num_attention_heads = 8
cfg.model.clip.num_hidden_layers = 3
